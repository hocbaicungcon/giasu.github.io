\begin{center}
	\textbf{{\Huge Lê Thánh Tông -- Nguyễn Khuyến HCM tháng 9}}
\end{center}
...
\begin{baitap}
	%\textbf{Câu 3.}
	Hình vẽ sau mô tả vị trí của máy bay vào thời điểm $9\mathrm{h}30$ phút. Biết các đơn vị trên hình tính theo đơn vị $\mathrm{km}$. Trong các khẳng định sau đây, khẳng định nào đúng, khẳng định nào sai?
	\begin{center}
		...
		\begin{tikzpicture}[line cap=round, line join=round, >=stealth, scale=1.1]
			...
			\node[rotate=20, font=\large] at (Airplane) {\faPlane};
