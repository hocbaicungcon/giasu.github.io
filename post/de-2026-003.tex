...
\begin{traloi}
	\dapan{A}
	Có tập xác định của hàm số là $ \mathbb{R}\setminus  \{1\}$ và $ y'=\frac{-5}{(x-1)^2} <0,\forall x\ne 1$. Do đó hàm số nghịch biến trên $ [-1;0] $ và $ \min\limits_{[-1;0]} y=y(0)= -3.$
\end{traloi}
\end{baitap}
...
%	\textbf{Câu 4.} 
	...
	\begin{traloi}
		\dapan{2} Giá trị của $m$ thỏa mãn yêu cầu bài toán là $m = 2$. Dưới đây là các bước giải chi tiết:
		\begin{itemize}
...
\begin{baitap}
%	\textbf{Câu 5.} 
	Một xưởng in có $8$ máy in, mỗi máy in được \num{3600} bản in trong một giờ. Chi phí để vận hành một máy in trong mỗi lần in là $50$ nghìn đồng. Chi phí cho $n$ máy in chạy trong một giờ là $60(6n + 10)$ nghìn đồng. Hỏi nếu in \num{50000} tờ quảng cáo thì phải sử dụng bao nhiêu máy in để được lãi nhiều nhất?
	\begin{traloi}
		\dapan{8}
		\begin{itemize}
		...
		\begin{itemize}
			\item Với $n = 5$:$$C(5) = 50(5) + \dfrac{2500}{3} + \dfrac{12500}{9 \cdot 5} = 250 + \dfrac{2500}{3} + \dfrac{2500}{9} = \dfrac{12250}{9} \approx 1361{,}11 \text{ (nghìn đồng)}$$
		\item Với $n = 6$:$$C(6) = 50(6) + \dfrac{2500}{3} + \dfrac{12500}{9 \cdot 6} = 300 + \dfrac{2500}{3} + \dfrac{12500}{54} = \dfrac{36850}{27} \approx 1364{,}81 \text{ (nghìn đồng)}$$
		\end{itemize}
...
%	\textbf{Câu 6.} 
	...
	\begin{traloi}
		\dapan{108}	Chi phí thấp nhất để ông An thuê nhân công xây bể là 108 triệu đồng. Dưới đây là các bước giải chi tiết:
