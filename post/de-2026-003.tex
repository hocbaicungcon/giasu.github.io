...
\begin{baitap}
	...
	\begin{traloi}
		\dapan{C}
%		Giá trị lớn nhất của hàm số là $\frac{9}{4}$ (hoặc $2,25$). Dưới đây là các bước giải chi tiết:
%		\begin{itemize}
...
\begin{baitap}
	...
	\end{multicols}
	\begin{traloi}
		\dapan{C} Giá trị lớn nhất của hàm số trên khoảng $(-\infty; +\infty)$ là $M = \sqrt{2}$. 
...
\begin{baitap}
	...
	\end{multicols}
	\begin{traloi}
		\dapan{B} Giá trị lớn nhất của hàm số $y = 2x + \frac{1}{x}$ khi $x < 0$ là $-2\sqrt{2}$. 
%		Dưới đây là hai cách giải chi tiết:
%		\begin{itemize}
...
\begin{baitap}
	...
	\end{multicols}
	\begin{traloi}
		\dapan{D} Giá trị lớn nhất của hàm số $f(x) = x(1 - x^2)$ trên khoảng $(0; 1)$ là $\frac{2\sqrt{3}}{9}$.
%		Dưới đây là hai cách giải chi tiết:
%		\begin{itemize}
