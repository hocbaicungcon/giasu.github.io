...
%	\textbf{Câu 1.}  Lê thánh tông 25-26
	 Lợi nhuận thu được $P$ (nghìn $\text{USD}$) của một công ty khi dùng số tiền $x$ (nghìn $\text{USD}$) chi cho quảng cáo được cho bởi công thức $P = P(x) = -\dfrac{1}{10}x^3 + 6x^2 + 400$ với $x \ge 0$.
	\begin{enumerate}
