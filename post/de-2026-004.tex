...
%	\textbf{Câu 3.} 
	...
	\begin{traloi}
		...
		\begin{enumerate}
			...
			\item Sai. Ta có \(V=\dfrac13x^2\sqrt{49-14x+\dfrac{x^2}{2}}\). Vì \(V>0\), xét \(9V^2=x^4\left(49-14x+\dfrac{x^2}{2}\right)\). Khi đó
			\[
			(9V^2)'=x^3(3x^2-70x+196).
			\]
			Suy ra điểm cực đại phù hợp là \(x=\dfrac{35-7\sqrt{13}}{3}\approx3{,}25\).
			
			Khoan: ở đây lời giải bạn gửi cũng có một lỗi tính biệt thức. Phương trình \(3x^2-70x+196=0\) cho
			\[
			x=\frac{35\pm7\sqrt{13}}3,
			\]
			không phải \(\dfrac{35\pm7\sqrt{11}}3\). Vì vậy \(x\approx3{,}25\), nên câu 4 thực ra Đúng.
		\end{enumerate}
	\end{traloi}
\end{baitap}
