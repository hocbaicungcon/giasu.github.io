...
- Games tại `giai-tri/games.html` gồm 2048, Sói–Dê–Bắp cải (20 màn), Đong nước (50 màn, từ 2 đến 4 can) và đoán từ 5 chữ trong 6 lượt. Bộ từ cơ bản chỉnh trong `assets/game-rules.js`; đây là trò chơi độc lập, không dùng dữ liệu của NYTimes.
- Qua sông: bấm nhân vật để lên/xuống thuyền, bấm thân thuyền để đi. Sức chở và số sói/dê/bắp cải thay đổi theo yêu cầu. Khi không có người trông, bất kỳ sói nào cũng ăn dê, bất kỳ dê nào cũng ăn bắp cải.
- Đong nước: chọn can rồi bấm vòi/chỗ xả để đổ đầy/đổ hết, bấm can khác để rót; bấm lại can đang chọn để bỏ chọn. Rót dừng khi nguồn hết hoặc đích đầy. Yêu cầu nêu rõ tổng lượng nước hoặc lượng nước trong một can; màn 7 lít đầu tiên dùng tổng hai can 5 và 3 lít.
- Nút ← / → đổi thử thách, ↻ chơi lại, biểu tượng loa bật/tắt âm thanh. Trình duyệt lưu màn đang chơi và tuỳ chọn âm thanh; mỗi lần tải trang sẽ khởi động lại màn đó. Các màn nằm trong `assets/puzzle-data.js`; kiểm tra BFS xác nhận tất cả đều giải được và đủ lượt.
- Hiệu ứng nước và âm thanh hoạt hình dùng tài nguyên CC0 của rubberduck trên OpenGameArt; nguồn và giấy phép trong `assets/audio/CREDITS.md`. Chỉ phát khi thao tác, không phát nền; hỗ trợ giảm chuyển động theo cài đặt thiết bị.
- Qua sông dùng tiếng mái chèo riêng từ BigSoundBank (Joseph SARDIN, CC0). Qua sông, đong nước và 2048 có cảnh thắng/thua trong bàn chơi, hoạt ảnh hữu hạn, nút chơi lại và chuyển màn (nếu còn màn); có thể xem lại bàn chơi. Chế độ giảm chuyển động tắt hoạt ảnh và giấy màu.
