...
if(board){
 ...
 function refresh(){
  ...
  if(conflicts){status.textContent=`Có ${conflicts} ô không còn khả năng. Hãy khôi phục biểu tượng hoặc hoàn tác.`;document.getElementById('einstein-progress').classList.add('attention');}
  save();
